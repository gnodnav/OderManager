app.controller('loginCtrl', ['$scope', 'svEmployee', '$location', '$localStorage', 'Notification', '$state', '$http', function ($scope, svEmployee, $location, $localStorage, Notification, $state, $http) {
